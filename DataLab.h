...
public:
    ...
    {
        return (Date1.GetYear() == Date1.GetYear()) ? ((Date1.GetMonth() == Date2.GetMonth()) ? ((Date1.GetDay() == Date2.GetDay()) ? true : false) : false) : false;
    }
    ...
    static clsDate DecreaseDateByOneDay(clsDate Date)
    {
        if (Date.GetDay() == 1)
        {
            ...
            else
            {
                ...
                Date._Month--;
                Date._Day = NumberOfDaysInAMonth(Date.GetMonth(), Date.GetYear());
            }
        }
        else
        {
    ...
    static bool IsBusinessDay(clsDate Date)
    {
        ...
        /*
         short DayIndex = DayOfWeekOrder(Date.Day, Date.Month, Date.GetYear());
    ...
    static short DaysUntilTheEndOfMonth(clsDate Date1)
    {
        ...
        EndOfMontDate._Day = NumberOfDaysInAMonth(Date1.GetMonth(), Date1.GetYear());
        EndOfMontDate._Month = Date1.GetMonth();
        EndOfMontDate._Year = Date1.GetYear();
    ...
    static short DaysUntilTheEndOfYear(clsDate Date1)
    {
        ...
        EndOfYearDate._Year = Date1.GetYear();
